  ...
  return (
    ...
    <div className="contact-banner">
        ...
        </div>
      {
        ...
        <p>
        This Privacy Policy explains how Manasik Aviation ("we," "us," "our") collects, uses, shares, and protects information in connection with Manasik's services, systems, websites, and apps that refer or link to this Privacy Policy (our "Services"), including without limitation, the collection and processing of personal information in connection with bookings and travel on Manasik Aviation or flights operated by our regional carriers. This Privacy Policy applies regardless of the type of device or other means you use to access our Services.
        </p>
        <p>
        Manasik reserves the right to change this Privacy Policy at any time by posting the updated Policy here along with the date on which the Policy was changed. If we make material changes to this Privacy Policy that affect the way we collect, use and/or share your personal information, we will notify you by including a "NEWLY UPDATED" label with the "PRIVACY POLICY" link on manasikaviation.com for 30 days after material changes are made.
        </p>
        </div>
